...
public class MainWindow extends javax.swing.JFrame {
    ...
    public MainWindow() {
        initComponents();
        setTitle("Image_Management_Tool.main");
        jLabel2.setText("Version : " +appVersion);
    ...
    private void initComponents() {
        ...
        jButton2.setFont(new java.awt.Font("Nachlieli CLM", 3, 18)); // NOI18N
        ...
        jButton3.setFont(new java.awt.Font("Nachlieli CLM", 3, 18)); // NOI18N
        ...
        jButton4.setFont(new java.awt.Font("Nachlieli CLM", 3, 18)); // NOI18N
        jButton4.setForeground(new java.awt.Color(255, 255, 255));
        jButton4.setText("Slide Show");
        ...
        jLabel2.getAccessibleContext().setAccessibleName("appversion");

        jLabel1.setFont(new java.awt.Font("Miriam Libre", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Image Management Tool");
        ...
        jLabel1.getAccessibleContext().setAccessibleName(" Image Management Tool ");

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -7, 640, 720));
